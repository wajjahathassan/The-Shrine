...
def search_context(query):
    ...
    try:
        ...
        return "Error: Embeddings not found. Did you run create_embeddings.py?"

    # Setup FAISS (The Librarian)
    ...
    # Load the Brain (The "Translator")
    model = SentenceTransformer('all-MiniLM-L6-v2')

    # Translate the Question
    # It wraps it in a list [query] because the model expects a list
